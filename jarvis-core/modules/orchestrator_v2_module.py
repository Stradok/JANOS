...
class OrchestratorV2Module(ModuleBase):
    ...
    KEYWORD_ROUTES = {
        ...
        "system": [
            ...
            "system settings", "what apps", "is installed", "check if",
            "install app", "uninstall", "run command", "terminal command",
            "what is running", "kill process", "system info",
        ],
        "research": [
